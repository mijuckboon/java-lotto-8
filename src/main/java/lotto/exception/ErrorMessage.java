...
public enum ErrorMessage {
    ...
    DUPLICATE_NUMBER("당첨 번호는 중복될 수 없습니다. (입력 번호: %s)"),
    ...
    // 보너스 번호
    BONUS_NUMBER_ALREADY_CHOOSED("보너스 번호는 당첨 번호와 중복될 수 없습니다. (보너스 번호: %d, 당첨 번호: %s)"),

    // 일반 예외 처리
    INVALID_INPUT_STRING("잘못된 입력값입니다. (입력값: %s)")
    ;
