...
class ResultComputerTest {
    ...
    static Stream<Arguments> lottoAndExpectedRankProvider() {
        Map<LottoRank, Integer> ranksForTwoNoGains = constructRanksForTwoNoGains();
        Map<LottoRank, Integer> ranksForOneFifthRankAndNoGain = constructRanksForOneFifthRankAndOneNoGain();
        ...
        return Stream.of(
                ...
                Arguments.of(
                        ...
                        ranksForOneFifthRankAndNoGain
                )
        );
    }

    private static Map<LottoRank, Integer> constructRanksForTwoNoGains() {
        Map<LottoRank, Integer> noGains = new HashMap<>();
        noGains.put(null, 2);
        return noGains;
    }

    private static Map<LottoRank, Integer> constructRanksForOneFifthRankAndOneNoGain() {
